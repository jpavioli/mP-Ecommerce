...
export default function manageCart(state = {
  ...
  switch (action.type) {
    ...
    case 'RESET':
      ...
      fetch(`https://polar-journey-37815.herokuapp.com/users/`, {
          method: 'POST',
          headers: {
        ...
        .then(res=>res.json())
        .then(data=>{
          fetch(`https://polar-journey-37815.herokuapp.com/orders/`, {
              method: 'POST',
              headers: {
                'content-type':'application/json',
              },
          ...
          cartObj.forEach(orderProduct=>{
            fetch(`https://polar-journey-37815.herokuapp.com/orderproducts/`, {
                method: 'POST',
                headers: {
                  'content-type':'application/json',
                },
